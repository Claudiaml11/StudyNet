        ...
        <div class="columns is-multiline">
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 bt-4">Study at your own pace</h2>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 bt-4">Study with others</h2>
              <p>This is just some random placeholder text</p>
            </div>
          </div>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 bt-4">Study from your home</h2>
              <p>This is just some random placeholder text place here</p>
            </div>
          </div>
